...
def updateCallback(client, callback_query,redis):
  ...
  if group == True and int(date[2]) == userID and not redis.get("{}Nbot:floodUsers:{}".format(BOT_ID,userID)):
    ...
    if date[0] == "ShowDateUser":
      ...
      age = getAge(userID,r)
      reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(Name(userFN),url="t.me/Source_Ze")],[InlineKeyboardButton(r.Rrank.format(t),url="t.me/Source_Ze")],[InlineKeyboardButton(r.Rmsgs.format(msgs),url="t.me/Source_Ze")],[InlineKeyboardButton(r.Rrate.format(str(rate)+"%"),url="t.me/Source_Ze")],[InlineKeyboardButton(r.Redits.format(edits),url="t.me/Source_Ze")],[InlineKeyboardButton(r.Rage.format(age),url="t.me/Source_Ze")]])
